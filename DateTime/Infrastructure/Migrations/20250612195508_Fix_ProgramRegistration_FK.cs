...
{
    /// <inheritdoc />
    public partial class Fix_ProgramRegistration_FK : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationGroup = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Participants_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Participants_BranchId",
                table: "Participants",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_Participants_CreatedByUserId",
                table: "Participants",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgramRegistration_UserId1",
                table: "ProgramRegistration",
                column: "UserId1");
